...
"production" !== ("TURBOPACK compile-time value", "development") && function() {
    ...
    function updateSuspenseComponent(current, workInProgress, renderLanes) {
        ...
        (JSCompiler_object_inline_digest_2307 = didSuspend) || (JSCompiler_object_inline_digest_2307 = null !== current && null === current.memoizedState ? !1 : 0 !== (suspenseStackCursor.current & ForceSuspenseFallback));
        JSCompiler_object_inline_digest_2307 && (JSCompiler_object_inline_componentStack_2309 = !0, workInProgress.flags &= -129);
        JSCompiler_object_inline_digest_2307 = 0 !== (workInProgress.flags & 32);
        workInProgress.flags &= -33;
        if (null === current) {
            if (isHydrating) {
                JSCompiler_object_inline_componentStack_2309 ? pushPrimaryTreeSuspenseHandler(workInProgress) : reuseSuspenseHandlerOnStack(workInProgress);
                if (isHydrating) {
                    ...
                    JSCompiler_temp && (warnNonHydratedInstance(workInProgress, JSCompiler_object_inline_message_2306), throwOnHydrationMismatch(workInProgress));
                }
                JSCompiler_object_inline_message_2306 = workInProgress.memoizedState;
                if (null !== JSCompiler_object_inline_message_2306 && (JSCompiler_object_inline_message_2306 = JSCompiler_object_inline_message_2306.dehydrated, null !== JSCompiler_object_inline_message_2306)) return JSCompiler_object_inline_message_2306.data === SUSPENSE_FALLBACK_START_DATA ? workInProgress.lanes = 16 : workInProgress.lanes = 536870912, null;
                popSuspenseHandler(workInProgress);
            }
            JSCompiler_object_inline_message_2306 = JSCompiler_object_inline_stack_2308.children;
            JSCompiler_object_inline_stack_2308 = JSCompiler_object_inline_stack_2308.fallback;
            if (JSCompiler_object_inline_componentStack_2309) return reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_componentStack_2309 = workInProgress.mode, JSCompiler_object_inline_message_2306 = mountWorkInProgressOffscreenFiber({
                mode: "hidden",
                children: JSCompiler_object_inline_message_2306
            }, JSCompiler_object_inline_componentStack_2309), JSCompiler_object_inline_stack_2308 = createFiberFromFragment(JSCompiler_object_inline_stack_2308, JSCompiler_object_inline_componentStack_2309, renderLanes, null), JSCompiler_object_inline_message_2306.return = workInProgress, JSCompiler_object_inline_stack_2308.return = workInProgress, JSCompiler_object_inline_message_2306.sibling = JSCompiler_object_inline_stack_2308, workInProgress.child = JSCompiler_object_inline_message_2306, JSCompiler_object_inline_componentStack_2309 = workInProgress.child, JSCompiler_object_inline_componentStack_2309.memoizedState = mountSuspenseOffscreenState(renderLanes), JSCompiler_object_inline_componentStack_2309.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_digest_2307, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2308;
            pushPrimaryTreeSuspenseHandler(workInProgress);
            return mountSuspensePrimaryChildren(workInProgress, JSCompiler_object_inline_message_2306);
        }
        var prevState = current.memoizedState;
        if (null !== prevState && (JSCompiler_object_inline_message_2306 = prevState.dehydrated, null !== JSCompiler_object_inline_message_2306)) {
            if (didSuspend) workInProgress.flags & 256 ? (pushPrimaryTreeSuspenseHandler(workInProgress), workInProgress.flags &= -257, workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes)) : null !== workInProgress.memoizedState ? (reuseSuspenseHandlerOnStack(workInProgress), workInProgress.child = current.child, workInProgress.flags |= 128, workInProgress = null) : (reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_componentStack_2309 = JSCompiler_object_inline_stack_2308.fallback, JSCompiler_object_inline_message_2306 = workInProgress.mode, JSCompiler_object_inline_stack_2308 = mountWorkInProgressOffscreenFiber({
                mode: "visible",
                children: JSCompiler_object_inline_stack_2308.children
            }, JSCompiler_object_inline_message_2306), JSCompiler_object_inline_componentStack_2309 = createFiberFromFragment(JSCompiler_object_inline_componentStack_2309, JSCompiler_object_inline_message_2306, renderLanes, null), JSCompiler_object_inline_componentStack_2309.flags |= 2, JSCompiler_object_inline_stack_2308.return = workInProgress, JSCompiler_object_inline_componentStack_2309.return = workInProgress, JSCompiler_object_inline_stack_2308.sibling = JSCompiler_object_inline_componentStack_2309, workInProgress.child = JSCompiler_object_inline_stack_2308, reconcileChildFibers(workInProgress, current.child, null, renderLanes), JSCompiler_object_inline_stack_2308 = workInProgress.child, JSCompiler_object_inline_stack_2308.memoizedState = mountSuspenseOffscreenState(renderLanes), JSCompiler_object_inline_stack_2308.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_digest_2307, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, workInProgress = JSCompiler_object_inline_componentStack_2309);
            else if (pushPrimaryTreeSuspenseHandler(workInProgress), isHydrating && console.error("We should not be hydrating here. This is a bug in React. Please file a bug."), JSCompiler_object_inline_message_2306.data === SUSPENSE_FALLBACK_START_DATA) {
                JSCompiler_object_inline_digest_2307 = JSCompiler_object_inline_message_2306.nextSibling && JSCompiler_object_inline_message_2306.nextSibling.dataset;
                ...
                JSCompiler_object_inline_message_2306 = JSCompiler_object_inline_message_2306 ? Error(JSCompiler_object_inline_message_2306) : Error("The server could not finish this Suspense boundary, likely due to an error during server rendering. Switched to client rendering.");
                JSCompiler_object_inline_message_2306.stack = JSCompiler_object_inline_stack_2308 || "";
                JSCompiler_object_inline_message_2306.digest = JSCompiler_object_inline_digest_2307;
                JSCompiler_object_inline_digest_2307 = void 0 === JSCompiler_object_inline_componentStack_2309 ? null : JSCompiler_object_inline_componentStack_2309;
                "string" === typeof JSCompiler_object_inline_digest_2307 && CapturedStacks.set(JSCompiler_object_inline_message_2306, JSCompiler_object_inline_digest_2307);
                queueHydrationError({
            ...
            } else if (JSCompiler_object_inline_digest_2307 = 0 !== (renderLanes & current.childLanes), didReceiveUpdate || JSCompiler_object_inline_digest_2307) {
                ...
                if (null !== JSCompiler_object_inline_digest_2307) {
                    ...
                    if (0 !== (JSCompiler_object_inline_stack_2308 & 42)) JSCompiler_object_inline_stack_2308 = 1;
                    else switch(JSCompiler_object_inline_stack_2308){
                        case 2:
                    ...
                    JSCompiler_object_inline_stack_2308 = 0 !== (JSCompiler_object_inline_stack_2308 & (JSCompiler_object_inline_digest_2307.suspendedLanes | renderLanes)) ? 0 : JSCompiler_object_inline_stack_2308;
                    if (0 !== JSCompiler_object_inline_stack_2308 && JSCompiler_object_inline_stack_2308 !== prevState.retryLane) throw prevState.retryLane = JSCompiler_object_inline_stack_2308, enqueueConcurrentRenderForLane(current, JSCompiler_object_inline_stack_2308), scheduleUpdateOnFiber(JSCompiler_object_inline_digest_2307, current, JSCompiler_object_inline_stack_2308), SelectiveHydrationException;
                }
                JSCompiler_object_inline_message_2306.data === SUSPENSE_PENDING_START_DATA || renderDidSuspendDelayIfPossible();
                workInProgress = retrySuspenseComponentWithoutHydrating(current, workInProgress, renderLanes);
            } else JSCompiler_object_inline_message_2306.data === SUSPENSE_PENDING_START_DATA ? (workInProgress.flags |= 128, workInProgress.child = current.child, workInProgress = retryDehydratedSuspenseBoundary.bind(null, current), JSCompiler_object_inline_message_2306._reactRetry = workInProgress, workInProgress = null) : (current = prevState.treeContext, nextHydratableInstance = getNextHydratable(JSCompiler_object_inline_message_2306.nextSibling), hydrationParentFiber = workInProgress, isHydrating = !0, hydrationErrors = null, didSuspendOrErrorDEV = !1, hydrationDiffRootDEV = null, rootOrSingletonContext = !1, null !== current && (warnIfNotHydrating(), idStack[idStackIndex++] = treeContextId, idStack[idStackIndex++] = treeContextOverflow, idStack[idStackIndex++] = treeContextProvider, treeContextId = current.id, treeContextOverflow = current.overflow, treeContextProvider = workInProgress), workInProgress = mountSuspensePrimaryChildren(workInProgress, JSCompiler_object_inline_stack_2308.children), workInProgress.flags |= 4096);
            return workInProgress;
        }
        if (JSCompiler_object_inline_componentStack_2309) return reuseSuspenseHandlerOnStack(workInProgress), JSCompiler_object_inline_componentStack_2309 = JSCompiler_object_inline_stack_2308.fallback, JSCompiler_object_inline_message_2306 = workInProgress.mode, JSCompiler_temp = current.child, instance = JSCompiler_temp.sibling, JSCompiler_object_inline_stack_2308 = createWorkInProgress(JSCompiler_temp, {
            mode: "hidden",
            children: JSCompiler_object_inline_stack_2308.children
        }), JSCompiler_object_inline_stack_2308.subtreeFlags = JSCompiler_temp.subtreeFlags & 31457280, null !== instance ? JSCompiler_object_inline_componentStack_2309 = createWorkInProgress(instance, JSCompiler_object_inline_componentStack_2309) : (JSCompiler_object_inline_componentStack_2309 = createFiberFromFragment(JSCompiler_object_inline_componentStack_2309, JSCompiler_object_inline_message_2306, renderLanes, null), JSCompiler_object_inline_componentStack_2309.flags |= 2), JSCompiler_object_inline_componentStack_2309.return = workInProgress, JSCompiler_object_inline_stack_2308.return = workInProgress, JSCompiler_object_inline_stack_2308.sibling = JSCompiler_object_inline_componentStack_2309, workInProgress.child = JSCompiler_object_inline_stack_2308, JSCompiler_object_inline_stack_2308 = JSCompiler_object_inline_componentStack_2309, JSCompiler_object_inline_componentStack_2309 = workInProgress.child, JSCompiler_object_inline_message_2306 = current.child.memoizedState, null === JSCompiler_object_inline_message_2306 ? JSCompiler_object_inline_message_2306 = mountSuspenseOffscreenState(renderLanes) : (JSCompiler_temp = JSCompiler_object_inline_message_2306.cachePool, null !== JSCompiler_temp ? (instance = CacheContext._currentValue, JSCompiler_temp = JSCompiler_temp.parent !== instance ? {
            parent: instance,
            pool: instance
        } : JSCompiler_temp) : JSCompiler_temp = getSuspendedCache(), JSCompiler_object_inline_message_2306 = {
            baseLanes: JSCompiler_object_inline_message_2306.baseLanes | renderLanes,
            cachePool: JSCompiler_temp
        }), JSCompiler_object_inline_componentStack_2309.memoizedState = JSCompiler_object_inline_message_2306, JSCompiler_object_inline_componentStack_2309.childLanes = getRemainingWorkInPrimaryTree(current, JSCompiler_object_inline_digest_2307, renderLanes), workInProgress.memoizedState = SUSPENDED_MARKER, JSCompiler_object_inline_stack_2308;
        pushPrimaryTreeSuspenseHandler(workInProgress);
        ...
        null !== current && (JSCompiler_object_inline_digest_2307 = workInProgress.deletions, null === JSCompiler_object_inline_digest_2307 ? (workInProgress.deletions = [
            current
        ], workInProgress.flags |= 16) : JSCompiler_object_inline_digest_2307.push(current));
    ...
    (function() {
        ...
        if ("19.0.0-rc-3208e73e-20240730" !== isomorphicReactPackageVersion) throw Error('Incompatible React versions: The "react" and "react-dom" packages must have the exact same version. Instead got:\n  - react:      ' + (isomorphicReactPackageVersion + "\n  - react-dom:  19.0.0-rc-3208e73e-20240730\nLearn more: https://react.dev/warnings/version-mismatch"));
    })();
