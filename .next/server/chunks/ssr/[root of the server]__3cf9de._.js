...
// import { mockProductTwo} from "../../../mock-data";
...
//             >
//               <Gallery
//                 images={productDetail.images.slice(0, 5).map((image: Image) => ({
//                   src: image.url,
...
//   const { handle } = params;
//   const { productDetail, fetchProductDetail } = useStore();
//   const productDetail = await fetchProductDetail(handle);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__3cf9de._.js.map